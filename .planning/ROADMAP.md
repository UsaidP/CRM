...
| **08** | [`08-real-inventory-scraping-media-vault`](file:///Users/usaidpatel/Desktop/CRM/.planning/phases/08-real-inventory-scraping-media-vault/PLAN.md) | **Real Kharghar & Taloja Inventory Scraping & Media Vault**<br>• Real inventory ingestion & RERA mapping<br>• Media vault management & rich floor plans<br>• Automated brochure & cost sheet extraction | `/agency-software-architect`<br>`/agency-backend-architect` | Ready for Execution |
| **09** | [`09-lead-reminders-calendar-next-connect`](file:///Users/usaidpatel/Desktop/CRM/.planning/phases/09-lead-reminders-calendar-next-connect/PLAN.md) | **Lead Reminders, Interactive Calendar & Next Connect Engine**<br>• Daily schedule & interactive agenda view<br>• Intelligent Next Connect priority scoring<br>• One-click WhatsApp & call trigger logging | `/agency-software-architect`<br>`/agency-frontend-developer` | Ready for Execution |
| **10** | [`10-cobalt-design-system-unification`](file:///Users/usaidpatel/Desktop/CRM/.planning/phases/10-cobalt-design-system-unification/PLAN.md) | **Cobalt Modern-Minimal Design System Unification**<br>• Deprecate `gold-ink` and `monochrome` legacy themes<br>• Pure OKLCH dark workbench palette & electric cobalt accent<br>• Space Grotesk / Inter / JetBrains Mono typography<br>• 100% full-app component refactoring & token alignment | `/agency-frontend-developer`<br>`/agency-ui-designer` | Ready for Execution |
| **11** | [`11-hallmark-crm-ui-ux-architecture-screens`](file:///Users/usaidpatel/Desktop/CRM/.planning/phases/11-hallmark-crm-ui-ux-architecture-screens/PLAN.md) | **Fresh Anti-AI-Slop Hallmark UI/UX Architecture & Stitch Screen Suite**<br>• Botanical Ledger palette (Cypress Forest Green, Amber Ochre, Alabaster)<br>• Leadrat & Brixi AI dual-pane spreadsheet-speed telecaller console<br>• CRMThread speed-to-lead & 7-stage attribution pipeline<br>• 8-Screen Stitch MCP generation matrix & design system contract | `/agency-ux-architect`<br>`/agency-ui-designer` | Ready for Execution |
| **13** | [`13-rera-plot-threshold-and-unregistered-inventory-governance`](file:///Users/usaidpatel/Desktop/CRM/.planning/phases/13-rera-plot-threshold-and-unregistered-inventory-governance/PLAN.md) | **RERA Plot Threshold Governance & Unregistered Inventory Ingestion**<br>• Statutory plot threshold (mandatory only if plot > 500 sq.m / 5,382 sq.ft)<br>• RERA Section 3(2)(a) small-plot statutory exemption badge<br>• Permissive creation with `RERA Not Updated` flag<br>• Form updates with live unit conversion (sq.m / sq.ft) | `/agency-backend-architect`<br>`/agency-frontend-developer` | Ready for Execution |
