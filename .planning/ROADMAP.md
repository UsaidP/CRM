...
| **12** | [`12-oci-always-free-deployment`](file:///Users/usaidpatel/Desktop/CRM/.planning/phases/12-oci-always-free-deployment/PLAN.md) | **OCI Always Free Deployment & Automated CI/CD**<br>• ARM64 Ampere A1 instance (1 OCPU / 6 GB RAM / 100 GB)<br>• Nginx reverse proxy + Let's Encrypt SSL<br>• PM2 process manager + standalone Next.js build<br>• GitHub Actions auto-deploy on push to `main` | `/agency-software-architect`<br>`/agency-devops-automator` | Ready for Execution |
