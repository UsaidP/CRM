...
export const createUnitSchema = z.object({
  ...
  reraCarpetAreaSqft: z.number().int().positive().optional().nullable(),
  traditionalCarpetSqft: z.number().int().positive().optional().nullable(),
  builtUpSqft: z.number().int().positive().optional().nullable(),
  balconyTerraceSqft: z.number().int().min(0).optional().nullable(),
  internalWallsSqft: z.number().int().min(0).optional().nullable(),
  externalWallsSqft: z.number().int().min(0).optional().nullable(),
  proportionateCommonSqft: z.number().int().min(0).optional().nullable(),
  saleableAreaSqft: z.number().int().positive('Saleable area must be positive').optional().nullable(),
  loadingPercentage: z.number().min(0).max(100).optional().nullable(),
